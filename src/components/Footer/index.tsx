      ...
      <Div className="cs-fooer_main">
        <Div className="container">
          <Div className="row">
            ...
            <Div className="col-lg-3 col-sm-6">
              <Div className="cs-footer_item">
                 <MenuWidget menuItems={serviceMenu} menuHeading="Services" variant={'cs-style1'}/> 
              </Div>
            </Div>
            <Div className="col-lg-3 col-sm-6">
              <Div className="cs-footer_item">
      ...
      <Div className="container">
        <Div className="cs-bottom_footer">
          ...
          <Div className="cs-bottom_footer_right">
             <MenuWidget menuItems={copyrightLinks} variant=" cs-style2"  menuHeading={'Copyright Links'}/>
          </Div>
        </Div>
      </Div>
    </footer>
